...
describe('Application Schematic', () => {
  ...
  it('should create all files of an application', async () => {
    ...
    expect(files).toEqual(
      expect.arrayContaining([
        ...
        '/projects/foo/src/modules/foo/components/.gitkeep',
        '/projects/foo/src/modules/foo/containers/.gitkeep',
        ...
        '/projects/foo/src/modules/foo/sandbox/.gitkeep',
  ...
  describe('custom projectRoot', () => {
    ...
    it('should set values in angular.json correctly', () => {
      ...
      expect(testOpt.styles).toEqual(['src/styles.scss']);
    });
