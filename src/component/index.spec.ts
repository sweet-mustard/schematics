...
describe('Component Schematic', () => {
  ...
  it('should respect the inlineStyle option', async () => {
    ...
    expect(tree.files).not.toContain('/projects/bar/src/app/foo/foo.component.scss');
  });
  ...
  it('should respect the sourceRoot value', async () => {
    ...
    await expect(schematicRunner.runSchematicAsync('component', defaultOptions, appTree).toPromise()).rejects;
