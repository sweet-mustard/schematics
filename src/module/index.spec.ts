...
describe('Module Schematic', () => {
  ...
  it('should create a module', async () => {
    ...
    expect(files).toEqual(expect.arrayContaining(['/projects/bar/src/app/foo/foo.module.ts']));
  });
  ...
  it('should create a routing module', async () => {
    ...
    const files = tree.files;
    expect(files).toEqual(expect.arrayContaining(['/projects/bar/src/app/foo/foo.module.ts']));
    expect(files).toEqual(expect.arrayContaining(['/projects/bar/src/app/foo/foo-routing.module.ts']));
  ...
  it('should dasherize a name', async () => {
    ...
    const tree = await schematicRunner.runSchematicAsync('module', options, appTree).toPromise();
    const files = tree.files;
    expect(files).toEqual(expect.arrayContaining(['/projects/bar/src/app/two-word/two-word.module.ts']));
  });
  ...
  it('should respect the sourceRoot value', async () => {
    ...
    expect(appTree.files).toEqual(expect.arrayContaining(['/projects/bar/custom/app/foo/foo.module.ts']));
  });
  ...
  describe('lazy route generator', () => {
    ...
    it('should generate a lazy loaded module with embedded route declarations', async () => {
      ...
      expect(files).toEqual(expect.arrayContaining(['/projects/bar/src/app/foo/foo.module.ts']));
      expect(files).not.toEqual(expect.arrayContaining(['/projects/bar/src/app/foo/foo-routing.module.ts']));
      expect(files).toEqual(expect.arrayContaining(['/projects/bar/src/app/foo/containers/foo/foo.container.ts']));
      expect(files).toEqual(expect.arrayContaining(['/projects/bar/src/app/foo/containers/foo/foo.container.html']));
      expect(files).toEqual(expect.arrayContaining(['/projects/bar/src/app/foo/containers/foo/foo.container.scss']));
    ...
    it('should generate a lazy loaded module and add route in another parallel routing module', async () => {
      ...
      expect(tree.files).toEqual(
        expect.arrayContaining([
          ...
          '/projects/bar/src/app/bar/containers/bar/bar.container.ts'
        ])
      );
